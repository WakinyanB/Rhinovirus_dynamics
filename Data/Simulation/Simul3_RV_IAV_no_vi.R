...
setwd(".../Desktop/RV/Data_and_Codes/Data/Simulation_v2")
...
plot(b0_rv*(1+a1_rv*cos(4*pi*((1:52)/52-d1_rv))+a2_rv*cos(2*pi*((1:52)/52-(d1_rv+d2_rv))))/gamma_rv,
     ylim=c(1.3,2.2), type='l', col='blue')
...
# write.csv2(SIR, "SIR_3_no_vi.csv", row.names=FALSE)
# saveRDS(parms, "parms_simul_3_no_vi.rds")
...
save(obs_rv, obs_iav, file="cases_3_no_vi.RData")
...
# write.csv2(SIR_kick, "SIR_kick_3_no_vi.csv", row.names=FALSE)
...
save(obs_kick_rv, obs_kick_iav, file="cases_kick_3_no_vi.RData")
...
# write.csv2(SIR_shift, "SIR_shift_3_no_vi.csv", row.names=FALSE)
...
save(obs_shift_rv, obs_shift_iav, file="cases_shift_3_no_vi.RData")