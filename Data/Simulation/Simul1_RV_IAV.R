...
saveRDS(subset(SIR, pathogen=="RV" & time==0), "init1_RV.rds")
saveRDS(parms, "parms1_simul.rds")
...
saveRDS(subset(SIR_kick, pathogen=="RV" & time==0), "init1_kick_RV.rds")
...
saveRDS(subset(SIR_shift, pathogen=="RV" & time==0), "init1_shift_RV.rds")
